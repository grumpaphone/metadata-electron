...
export const FolderIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const SettingsIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const PlayIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill={color} className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M4.5 2.5v11l9-5.5-9-5.5z" />
	</svg>
);

export const PauseIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill={color} className={className} aria-hidden={ariaHidden} focusable="false">
...
export const StopIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill={color} className={className} aria-hidden={ariaHidden} focusable="false">
		<rect x="3" y="3" width="10" height="10" rx="1.5" />
	</svg>
);

export const VolumeIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const VolumeMuteIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M2 6.5h2.5L8 3.5v9l-3.5-3H2a.5.5 0 0 1-.5-.5V7a.5.5 0 0 1 .5-.5z" fill={color} />
...
export const DropFileIcon: React.FC<IconProps> = ({ size = 48, color = defaults.color, className }) => (
	<svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} role="img" focusable="false">
...
export const WaveformIcon: React.FC<IconProps> = ({ size = 64, color = defaults.color, className }) => (
	<svg width={size} height={size * 0.6} viewBox="0 0 64 38" fill="none" className={className} role="img" focusable="false">
...
export const CheckboxIcon: React.FC<IconProps & { checked: boolean }> = ({ size = 14, color = defaults.color, checked, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 14 14" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const SortAscIcon: React.FC<IconProps> = ({ size = 10, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 10 10" fill={color} className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M5 1L9 7H1L5 1z" />
	</svg>
);

export const SortDescIcon: React.FC<IconProps> = ({ size = 10, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 10 10" fill={color} className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M5 9L1 3h8L5 9z" />
	</svg>
);

export const CloseIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M4 4l8 8M12 4l-8 8" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
	</svg>
);

export const KeyboardIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const MinimizeIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M4 12l4-4 4 4" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
	</svg>
);

export const FinderIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const CopyIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
...
export const FullscreenIcon: React.FC<IconProps> = ({ size = defaults.size, color = defaults.color, className, 'aria-hidden': ariaHidden = true }) => (
	<svg width={size} height={size} viewBox="0 0 16 16" fill="none" className={className} aria-hidden={ariaHidden} focusable="false">
		<path d="M3 7V3h4M13 9v4H9M9 3h4v4M7 13H3V9" stroke={color} strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
	</svg>
);
